...
root = Tk() # Init app
root.title("Image_viewer_2") # Set title here
...
status = Label(root, text=f"Image 1 of { len(image_list) }", bd=1, relief=SUNKEN, anchor=E) # Init status
